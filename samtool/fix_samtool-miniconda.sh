...
if [ "$conda_env" == "base" ]; then
  ...
  anaconda_path="$HOME/miniconda3"  # Replace with your Anaconda installation path
else
  # In a custom environment
  anaconda_path="$HOME/miniconda3/envs/$conda_env"  # Replace with your Anaconda installation path
fi
